:- lib(ic).
:- lib(timeout).
boundedQueueIsFull_31([Data_pre,Bound_pre,Size_pre],[],[Data,Bound,Size],[],[],[]):-
Size_pre#=4,
Bound_pre#=<0,
Data=Data_pre,
Bound=Bound_pre,
Size=Size_pre,Bound#>=0,
Size#>=0,
Size#=<Bound.
testBoundedQueueIsFull(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Bound,Size],
boundedQueueIsFull_31(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
