:- lib(ic).
:- lib(timeout).
boundedQueueDequeue_744([Data_pre,Bound_pre,Size_pre],[],[Data,Bound,Size],[],[],[]):-
Size_pre#=4,
,Bound#>=0,Size#>=0,Size#=<Bound.
testBoundedQueueDequeue(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Bound,Size],
boundedQueueDequeue_744(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
