:- lib(ic).
:- lib(timeout).
boundedQueueSize_10([Data_pre,Bound_pre,Size_pre],[],[Data,Bound,Size],[],[],[]):-
Size_pre#=4,
,
Data=Data_pre,
Bound=Bound_pre,
Size=Size_pre,Bound#>=0,Size#>=0,Size#=<Bound.
testBoundedQueueSize(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Bound,Size],
boundedQueueSize_10(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
