:- lib(ic).
:- lib(timeout).
triangleEquals_9([SideA_pre,SideB_pre,SideC_pre],[T_SideA_pre,T_SideB_pre,T_SideC_pre],[SideA,SideB,SideC],[T_SideA,T_SideB,T_SideC],[],[]):-
,
SideA=SideA_pre,
SideB=SideB_pre,
SideC=SideC_pre,
...
triangleEquals_9(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
labeling(Obj_pre),
