:- lib(ic).
:- lib(timeout).
unboundedStackPush_15([Data_pre,Size_pre],[Value_pre],[Data,Size],[Value],[],[]):-
Size_pre#=x,
,
Value=Value_pre,Size#>=0.
testUnboundedStackPush(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Size],
Arg=[Value],
unboundedStackPush_15(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
