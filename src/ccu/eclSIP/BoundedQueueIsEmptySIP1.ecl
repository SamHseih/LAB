:- lib(ic).
:- lib(timeout).
boundedQueueIsEmpty_20([Data_pre,Bound_pre,Size_pre],[],[Data,Bound,Size],[],[],[]):-
Size_pre#=4,
,
Data=Data_pre,
Bound=Bound_pre,
Size=Size_pre,Bound#>=0,Size#>=0,Size#=<Bound.
testBoundedQueueIsEmpty(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Bound,Size],
boundedQueueIsEmpty_20(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
