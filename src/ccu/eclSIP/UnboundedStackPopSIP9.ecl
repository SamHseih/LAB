:- lib(ic).
:- lib(timeout).
unboundedStackPop_19([Data_pre,Size_pre],[],[Data,Size],[],[],[]):-
Size_pre#=x,
,Size#>=0.
testUnboundedStackPop(Obj_pre,Arg_pre,Obj,Arg,Result,Exception):-
...
Obj=[Data,Size],
unboundedStackPop_19(Obj_pre,Arg_pre,Obj,Arg,Result,Exception),
