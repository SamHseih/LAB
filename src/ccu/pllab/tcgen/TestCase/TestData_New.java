...
public class TestData_New {
	private List<ECLiPSe_CompoundTerm> solution;

	private String className;
	private String methodName;
	private Object obj_pre;
	private Object arg_pre;
	private Object obj_post;
	private Object arg_post;
	...
	public TestData_New(String className, String methodName, int pathid, int testDataID, boolean isConstructor,
		...
		if (this.exception.toString().contains("Exception")) {
			this.invalidated = true;
		}
		this.retType = retType;
	}

	public TestData_New(String className, String methodName, int pathid, int testDataID, int arrayID, boolean isConstructor,
		...
		this.isConstructor = isConstructor;
		this.invalidated = false;
		if (this.ret_val.toString().contains("Exception")) {
			this.invalidated = true;
		}
		this.retType = retType;
	}
	...
	// classLevel
	public TestData_New(String className, Object methodName, Object objpre, Object argpre, Object objpost,
			Object argpost, Object retval, Object exception) {
		this.className = className;
	...
	public Object getObjPre() {
		return this.obj_pre;
	}

	public void setObjPre(Object objpre) {
		this.obj_pre = objpre;
	}
	...
	public void setArgPre(Object arg_pre) {
		this.arg_pre = arg_pre;
	}

	public Object getArgPre() {
		return this.arg_pre;
	}

	public Object getException() {
		String exe = "[]";
		if (this.exception != null && this.exception.toString().equals("[]") )
			return this.exception;
		return exe;
	}

	public Object getObjPost() {
