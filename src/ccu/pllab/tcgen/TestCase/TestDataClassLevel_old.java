...
public class TestDataClassLevel_old {
		...
		//---714
		public TestDataClassLevel_old(String className,ArrayList<String> methodName, int pathid, int testDataID, List<ECLiPSe_CompoundTerm> solution) {
