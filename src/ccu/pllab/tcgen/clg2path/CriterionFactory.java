...
public class CriterionFactory {
	...
	static public CoverageCriterion getCLGCoverage(Criterion criterion) {
		if (criterion.equals(CriterionFactory.Criterion.dc) || criterion.equals(CriterionFactory.Criterion.dcc)
				|| criterion.equals(CriterionFactory.Criterion.mcc)
				|| criterion.equals(CriterionFactory.Criterion.dcdup)
				|| criterion.equals(CriterionFactory.Criterion.dccdup)
