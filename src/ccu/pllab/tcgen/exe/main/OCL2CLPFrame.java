		...
		this.start_actionListener = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					 ...
					 * ast.getAbstractSyntaxTree(); clp = new OCL2CLP(ast.getAbstractSyntaxTree(),
					 * ast.getSymbolTable()); clp.AST2CLP(); JOptionPane.showMessageDialog(null,
					 * "Execution Succeed", "Result", JOptionPane.INFORMATION_MESSAGE); Main.invCLP
