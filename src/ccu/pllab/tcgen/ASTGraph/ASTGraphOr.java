...
public class ASTGraphOr extends ASTGraphNode {
	...
	public String getCLP(String attribute, String argument) {
		...
		argpre += "_pre";
		String clp = "operator_or_" + this.getId() + "([" + objpre + "],[" + argpre + "],[" + attribute + "],["
				+ argument + "],[Result]):-\n";
		if (this.getLeft() != null && !this.getLeft().getVisited()) {
			if (this.getLeft() instanceof ASTGraphAnd)
				clp += "operator_and_" + this.getLeft().getId() + "([" + objpre + "],[" + argpre + "],[" + attribute
						+ "],[" + argument + "],[Result]).\n";
			else if (this.getLeft() instanceof ASTGraphIf)
				clp += "operator_if_" + this.getLeft().getId() + "([" + objpre + "],[" + argpre + "],[" + attribute
						+ "],[" + argument + "],[Result]).\n";
			...
			if (this.getRight() instanceof ASTGraphAnd)
				clp += "operator_and_" + this.getRight().getId() + "([" + objpre + "],[" + argpre + "],[" + attribute
						+ "],[" + argument + "],[Result]).\n";
			else if (this.getLeft() instanceof ASTGraphIf)
				clp += "operator_if_" + this.getRight().getId() + "([" + objpre + "],[" + argpre + "],[" + attribute
						+ "],[" + argument + "],[Result]).\n";
